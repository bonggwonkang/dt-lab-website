...
const teaching = [
  { course: 'Facilities Planning and Material Handling Systems', term: 'Spring 2025' },
  { course: 'Digital Twin and Simulation Modeling',             term: 'Spring 2025' },
  { course: 'Introduction to Digital Twins',                    term: '2026' },
  { course: 'Probability and Statistics',                       term: 'Spring 2026' },
  { course: 'Creative Thinking for Engineering',                term: 'Spring 2026' },
  { course: 'Affective Quality Engineering',                    term: 'Spring 2026' },
]
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="md:col-span-1 flex flex-col items-center md:items-start gap-6">
              <div className="w-48 h-56 rounded-2xl overflow-hidden bg-gradient-to-br from-indigo-100 to-indigo-200 shadow-lg flex-shrink-0">
                <img
              ...
              <div className="text-center md:text-left">
                <h2 className="text-2xl font-bold text-gray-900">Bonggwon Kang</h2>
                <p className="text-gray-400 text-sm mt-0.5">강봉권</p>
                <p className="text-indigo-600 font-semibold text-sm mt-2">Assistant Professor</p>
                <p className="text-gray-500 text-sm">Department of Industrial Engineering</p>
                <p className="text-gray-500 text-sm">Kumoh National Institute of Technology</p>
              </div>
            ...
            <motion.div variants={fadeUp} className="md:col-span-2 space-y-12">
              ...
              <div>
                <h3 className="text-xs font-semibold text-indigo-600 tracking-[0.2em] uppercase mb-6">
                  Education &amp; Experience
                </h3>
                <div className="relative pl-6 border-l-2 border-gray-100 space-y-6">
                  {experience.map((e, i) => (
                    <div key={i} className="relative">
                      <span className="absolute -left-[9px] top-1.5 w-3.5 h-3.5 rounded-full border-2 border-white bg-indigo-400" />
                      <p className="text-xs font-semibold text-indigo-500 mb-0.5">{e.year}</p>
              ...
              {/* Teaching */}
              <div>
                <h3 className="text-xs font-semibold text-teal-600 tracking-[0.2em] uppercase mb-6">Teaching</h3>
                  ...
                  {teaching.map((t, i) => (
                    <div key={i} className="flex items-start justify-between gap-4 p-3.5 rounded-xl bg-gray-50 border border-gray-100">
                      <div className="flex items-start gap-3">
                        ...
                        <span className="text-sm text-gray-800 font-medium">{t.course}</span>
                      </div>
                      <span className="text-xs text-gray-400 whitespace-nowrap flex-shrink-0">{t.term}</span>
                    </div>
                  ))}
                </div>
              </div>
