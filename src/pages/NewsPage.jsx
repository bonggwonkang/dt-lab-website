...
const items = [
  ...
  { date: '2026.07', type: 'conference', img: '42.jpg',
    title: 'Participated in the 5th Decision Under Uncertainty Workshop',
    desc: 'Participated in and presented at the 5th Decision Under Uncertainty Workshop.' },
  { date: '2026.07', type: 'conference', img: '41.jpg',
    title: 'Invited Talk at Hanwha Ocean',
    desc: 'Delivered an invited talk at Hanwha Ocean on digital twin and simulation.' },
  ...
  { date: '2026.05', type: 'award', img: '40.png',
    title: 'Best Presentation Paper Award from the KORAS Spring Conference',
    desc: 'Received the Best Presentation Paper Award (No. 2026-KORAS-017) at the 2026 Spring Conference of the Korean Reliability Society (KORAS).' },
  ...
  return (
    <>
      ...
      <div className="mt-4 pt-4 border-t border-gray-200 dark:border-white/10">
        <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">{after}</p>
      </div>
    </>
  )
}
